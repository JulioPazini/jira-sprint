...
def process_excel_file():
    try:
        ...
        result_label.config(text="File saved to 'output.xlsx'", font=('Helvetica', 14), bootstyle='success')
        delete_file('sprint_data.csv')
...
def get_tickets():
    ...
    try:
        ...
        config_data = {"username": "", "api_token": ""}
    ...
    if response.status_code == 200:
        ...
        with open('sprint_data.csv', 'w', newline='') as csvfile:
